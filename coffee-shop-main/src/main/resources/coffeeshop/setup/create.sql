...
-- Tue Sep 18 10:08:47 2018
-- Model: Coffee Shop Main Data Model    Version: 1.0
...
CREATE TABLE IF NOT EXISTS `coffee_shop`.`address` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_address_customer1_idx` (`customer_user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `coffee_shop`.`product` (
  ...
  INDEX `fk_product_nutrition1_idx` (`nutrition_id` ASC),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC),
  INDEX `fk_product_image_storage1_idx` (`image_uuid` ASC),
  UNIQUE INDEX `image_uuid_UNIQUE` (`image_uuid` ASC),
...
CREATE TABLE IF NOT EXISTS `coffee_shop`.`ingredient` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ingredient_ingredient_category1_idx` (`ingredient_category_id` ASC),
...
CREATE TABLE IF NOT EXISTS `coffee_shop`.`season_special` (
  ...
  INDEX `fk_season_special_product1_idx` (`product_id` ASC),
...
CREATE TABLE IF NOT EXISTS `coffee_shop`.`product_option` (
  ...
  INDEX `fk_product_has_ingredient_category_ingredient_category1_idx` (`ingredient_category_id` ASC),
  INDEX `fk_product_has_ingredient_category_product1_idx` (`product_id` ASC),
...
CREATE TABLE IF NOT EXISTS `coffee_shop`.`ordered_product_has_ingredient` (
  ...
  INDEX `fk_ordered_product_has_ingredient_ingredient1_idx` (`ingredient_id` ASC),
  INDEX `fk_ordered_product_has_ingredient_ordered_product1_idx` (`ordered_product_id` ASC),
